  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl font-bold text-gray-700">All Registered Specialists</h3>
        <Link to="/admin/doctors/new" className="bg-[#00984a] text-white px-5 py-2.5 rounded-xl font-semibold shadow-md hover:bg-green-700"><i className="fas fa-plus mr-2 text-sm"></i> Add New Doctor</Link>
      </div>
