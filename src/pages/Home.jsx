  ...
  return (
    <div>
      ...
      <div className="relative z-10 w-full">
        <section className="relative min-h-[480px] sm:min-h-[550px] lg:h-[65vh] w-full overflow-hidden flex items-center py-12 sm:py-0">
          ...
          <div className="relative z-10 mx-auto flex h-full w-full max-w-7xl items-center px-4 sm:px-6 md:px-12">
            <div className="max-w-2xl p-5 sm:p-8 md:p-10 rounded-2xl space-y-4 sm:space-y-6">
              <div className="space-y-3">
                <h1 className="text-3xl sm:text-4xl leading-tight tracking-tight text-white md:text-5xl">Academic Faculty</h1>
                <div className="h-1 w-20 bg-emerald-900 rounded-full"></div>
              </div>
              <p className="text-base sm:text-lg leading-relaxed text-slate-50 md:text-xl font-light">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-2">
                <a href="#" className="inline-flex items-center justify-center rounded-full bg-emerald-900 px-8 py-3 sm:py-3.5 text-sm sm:text-base font-semibold text-white hover:bg-[#007d3c] shadow-lg">Apply Now</a>
                <a href="#" className="inline-flex items-center justify-center rounded-full border border-white/40 bg-white/10 px-8 py-3 sm:py-3.5 text-sm sm:text-base font-semibold text-white backdrop-blur-md hover:bg-white hover:text-slate-950">Read More</a>
              </div>
            </div>
          </div>
        </section>

        <section className="relative bg-transparent py-12 sm:py-16 lg:py-24 px-4 sm:px-6 md:px-12 overflow-hidden">
        ...
        <section className="py-8 sm:py-10 bg-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
            <div className="flex items-center justify-center mb-6 sm:mb-8"><div className="flex-grow border-t border-slate-900"></div><span className="mx-2 sm:mx-6 text-slate-900 text-lg sm:text-xl lg:text-[24px] font-bold text-center">Important Notices</span><div className="flex-grow border-t border-slate-900"></div></div>
            <div className="backdrop-blur-md rounded-2xl shadow-sm overflow-hidden divide-y">
              {[['Notice (DU Registration Fee)','267.18 KB','Aug 31, 2025'],['Shok Barta','1.02 MB','Jul 29, 2025'],['Notice for Foreign Students','201.79 KB','Jul 15, 2025']].map(([t,s,d],i) => (
                <div key={i} className="flex flex-col sm:grid sm:grid-cols-12 gap-1 sm:gap-0 sm:items-center px-4 sm:px-6 py-4 hover:bg-emerald-900/5">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-2">
                    ...
                    <span className="sm:col-span-4 md:col-span-3 sm:text-right"><span className="inline-block px-3 py-1 bg-slate-100 rounded-full text-[11px] sm:text-xs font-semibold text-slate-900 whitespace-nowrap">{d}</span></span>
                  </div>
                </div>
              ))}
            </div>
