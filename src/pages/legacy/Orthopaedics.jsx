  ...
  <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 relative z-10">
    ...
    <div class="w-full lg:w-1/2">
      ...
      <div class="space-y-6 text-lg text-slate-600 leading-relaxed font-light">
        <p class="relative pl-6 border-l-2 border-blue-100">
          Orthopaedics & Traumatology department deals with all sorts of trauma patients as well as Orthopaedic patients with congenital deformities, affection of spine, all sorts of arthritis & peripheral nerve injuries etc. The department is equipped to provide requisite teaching to clinical students & training to junior doctors by a strong faculty.
        </p>
    ...
    <div class="w-full lg:w-1/2 flex justify-center">
      <div class="relative group">
        ...
        <div id="ortho-slideshow" class="relative w-[300px] h-[400px] rounded-lg overflow-hidden ring-8 ring-white shadow-xl">
...
<script>
  (function() {
    let currentSlide = 0;
    const parent = document.querySelector('#ortho-slideshow').closest('section');
    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/ortho2.jpg" 
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/ortho3.jpg" 
