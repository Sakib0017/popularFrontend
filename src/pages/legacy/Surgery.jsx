  ...
  <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 relative z-10">
    ...
    <div class="w-full lg:w-1/2">
      ...
      <div class="space-y-6 text-lg text-slate-600 leading-relaxed font-light">
        <p class="relative pl-6 border-l-2 border-brand-200">
          The Department of Surgery boasts of a very strong faculty of eminent teachers. The number and variety of patients provide ample clinical material with adequate scope for hands-on-training. In addition to general surgery there are experienced and renowned teachers of different disciplines of surgery including ophthalmology, otolaryngology, orthopedic surgery, plastic surgery, urology, colorectal surgery etc.
        </p>
    ...
    <div class="w-full lg:w-1/2 flex justify-center">
      <div class="relative group">
        ...
        <div id="surgery-slideshow" class="relative w-[300px] h-[400px] rounded-lg overflow-hidden ring-8 ring-white shadow-xl">
...
<script>
  (function() {
    let currentSlide = 0;
    const parent = document.querySelector('#surgery-slideshow').closest('section');
    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/sur2022.jpg" 
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/surgery3.jpg" 
