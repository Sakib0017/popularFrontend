...
const HTML = `<section class="relative h-[50vh] min-h-[400px] flex items-center overflow-hidden">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 w-full">
      <div class="max-w-2xl border-l-4 border-brand-300 pl-6 md:pl-10">
          <span class="text-brand-600 font-bold tracking-widest uppercase text-sm mb-2 block">1st Year MBBS Resources</span>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="order-2 lg:order-1">
              ...
              <div class="space-y-4 text-slate-600 text-lg leading-relaxed">
                  <p>
                      Medicine is an ever-changing science. While the depth of knowledge required for a medical graduate is vast, we provide a <span class="text-brand-600 font-semibold">foundational list of essential books</span> to guide students through their first professional phase.
                  </p>
                  <p>
...
<section class="max-w-7xl mx-auto py-16 px-6  bg-white">
  <div class="mb-12">
    <span class="text-[10px] tracking-[0.3em] uppercase text-gray-400 font-bold border-l-2 border-brand-300 pl-3">Book List</span>
  </div>
