  ...
  <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 relative z-10">
    ...
    <div class="w-full lg:w-1/2 flex justify-center">
      <div class="relative group">
        ...
        <div id="slideshow" class="relative w-[300px] h-[400px] md:w-[300px] md:h-[400px]  rounded-lg overflow-hidden ring-8 ring-white">
          
          <img src="/assets/anatomy.jpg" class="slide absolute inset-0 w-full h-full  transition-all duration-1000 scale-110 opacity-0">
          <img src="/assets/for.jpeg" class="slide absolute inset-0 w-full h-full transition-all duration-1000 scale-110 opacity-0">
          <img src="/assets/medicine.jpg" class="slide absolute inset-0 w-full h-full  transition-all duration-1000 scale-110 opacity-0">
          <img src="/assets/micro.jpeg" class="slide absolute inset-0 w-full h-full  transition-all duration-1000 scale-110 opacity-0">
          <img src="/assets/orth.jpeg" class="slide absolute inset-0 w-full h-full  transition-all duration-1000 scale-110 opacity-0">

          <div class="absolute inset-0 bg-gradient-to-t from-slate-900/40 to-transparent pointer-events-none"></div>
        </div>

        <div class="absolute bottom-6 right-6 flex gap-2">
           <span class="w-2 h-2 rounded-full bg-white/50 slide-dot"></span>
           <span class="w-2 h-2 rounded-full bg-white/50 slide-dot"></span>
           <span class="w-2 h-2 rounded-full bg-white/50 slide-dot"></span>
           <span class="w-2 h-2 rounded-full bg-white/50 slide-dot"></span>
           <span class="w-2 h-2 rounded-full bg-white/50 slide-dot"></span>
...
<script>
  ...
  function showSlide(index) {
    slides.forEach((slide, i) => {
      if (i === index) {
        ...
        dots[i].classList.add('bg-white', 'w-4'); // Active dot
  ...
  }, 4000); // 4 seconds is better for readability/UX than 1 second
</script>
    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/ana2022.jpg" 
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/ana2022_1.jpg" 
  ...
  <div class="w-full overflow-hidden shadow-sm rounded-sm border border-blue-900/20 bg-blue-900/30">
