  ...
  <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 relative z-10">
    ...
    <div class="w-full lg:w-1/2">
      ...
      <div class="space-y-6 text-lg text-slate-600 leading-relaxed font-light">
        <p class="relative pl-6 border-l-2 border-blue-100">
          The Department of Pathology is provided with well equipped laboratory and a museum. The museum has good collection of specimens & charts. Hands on training is conducted in the laboratory. Practical demonstration is imparted on gross pathology in the museum in small groups.
        </p>
    ...
    <div class="w-full lg:w-1/2 flex justify-center">
      <div class="relative group">
        ...
        <div id="pathology-slideshow" class="relative w-[300px] h-[400px] rounded-lg overflow-hidden ring-8 ring-white shadow-xl">
...
<script>
  (function() {
    let currentSlide = 0;
    const parent = document.querySelector('#pathology-slideshow').closest('section');
    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/path2022.jpg" 
        ...
        <div class="relative group overflow-hidden shadow-xl rounded-sm">
          <img 
            src="https://www.pmch-bd.org/images/PMC/departments/patho3.jpg" 
